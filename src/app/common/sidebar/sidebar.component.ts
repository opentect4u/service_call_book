...
export class SidebarComponent implements OnInit {
  ...
  make_date_true() {
    this.done_dt_frm = true; this.done_dt_to = true; this.ct = 0; this.done_dt = true;
    this.frm = document.getElementById('frm');
    this.frm.value = '';
    this.t = document.getElementById('t');
    this.t.value = '';
  ...
  prevent_null(e: any) {
    if (e.target.value == '') { this.done = true; this.prevent = true; }
    else { this.done = false; this.prevent = false; }
  }
